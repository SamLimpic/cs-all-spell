...
namespace cs_all_spell
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<SpellReagentsService>();
            ...
            services.AddTransient<SpellReagentsRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "cs_all_spell", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "cs_all_spell v1"));
            }
